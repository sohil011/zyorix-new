...
export default function LabsAndDemos() {
  const labSimulations = [
    {
      id: 1,
      headline: "Azure Cost Management: Budget & Forecast Variance — Lab Simulation",
      company: "Lab Simulation (Fintech Profile)",
      industry: "Fintech",
      logo: "FS",
      challenge:
    ...
    {
      id: 2,
      headline: "Power BI FinOps Overview: Ownership, KPIs, Trends — Lab Demo",
      company: "Lab Simulation (Retail Tech Multi-Cloud)",
    ...
    <main>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-8 text-center">
              {[
                { value: "≈15-35%", label: "Target optimisation range (lab models)" },
                { value: "≈6-8 weeks", label: "Target ROI window (lab benchmarks)" },
                { value: "≈90-95%", label: "Target allocation coverage (lab standards)" },
              ].map((stat, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-20">
          {labSimulations.map((study, index) => (
            <motion.div
              key={study.id}
