...
export default function Home() {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* KPI value strip */}
      <div data-kpi-strip className="mt-6 grid gap-3 sm:grid-cols-4 text-sm">
        <div className="rounded-xl border bg-white p-4 text-center">
          <div className="text-2xl font-bold text-emerald-600">20-30%</div>
          <div className="text-slate-600">Cost Reduction (typical)</div>
        </div>
        <div className="rounded-xl border bg-white p-4 text-center">
          <div className="text-2xl font-bold text-emerald-600">±5-10%</div>
          <div className="text-slate-600">Forecast Accuracy</div>
        </div>
        <div className="rounded-xl border bg-white p-4 text-center">
          <div className="text-2xl font-bold text-emerald-600">90-95%</div>
          <div className="text-slate-600">Allocation Accuracy</div>
        </div>
        <div className="rounded-xl border bg-white p-4 text-center">
          <div className="text-2xl font-bold text-emerald-600">&lt;90 days</div>
          <div className="text-slate-600">Typical Payback</div>
        </div>
      </div>
